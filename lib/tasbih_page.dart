...
class _TasbihPageState extends State<TasbihPage> {
  ...
  void _showDialog(BuildContext context, String initialValue1,
      String initialValue2, String initialValue3, int func, int index_val) {
              ...
              onPressed: () {
                setState(() {
                  if (func == 0) {
                    ...
                    dhikir[index_val]["id"] = _inputValue1;
                    dhikir[index_val]["dhikir"] = _inputValue1;
                    dhikir[index_val]["arabic"] = _inputValue2;
                    dhikir[index_val]["translationEn"] = _inputValue3;
                    dhikir[index_val]["translationBn"] = _inputValue3;
                    myBox.delete("dhikirList");
                    myBox.put("dhikirList", dhikir);
                  }
                });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                          ...
                          children: [
                            Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child: Icon(
                                  Icons.edit,
                                  color: const Color.fromARGB(255, 10, 194, 16),
                                ),
                              ),
                            ),
                            Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child: Icon(
                                  Icons.delete,
                                  color: const Color.fromARGB(255, 243, 25, 10),
                                ),
                              ),
                            ),
                          ],
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: Color(0xFF00595a),
        onPressed: () {
